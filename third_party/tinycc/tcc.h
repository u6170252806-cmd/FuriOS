...
#if !defined(FUROS_TCC) && defined _WIN32 == defined TCC_TARGET_PE \
...
#define VT_THREAD  0x00010000  /* thread-local storage */
...
#define VT_STORAGE (VT_EXTERN | VT_STATIC | VT_TYPEDEF | VT_INLINE | VT_THREAD)
